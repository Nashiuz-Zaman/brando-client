...
const LoginSuccessToast = ({ show = false }) => {
  return (
    <div
      className={`fixed opacity-0 -top-full left-1/2 -translate-x-1/2 flex flex-col items-center gap-6 transition-all duration-150 rounded-default w-max px-8 py-4 shadow-[0_0_30px_rgba(0,0,0,0.2)] bg-white ${
